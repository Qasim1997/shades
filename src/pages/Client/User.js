...
import { useAddClientMutation, usePostUserInfoMutation } from "../../services/authApi";
...
function User() {
    ...
    const onSubmit = async (event) => {
        ...
        if (actualData.name && actualData.email && actualData.country && actualData.region && actualData.city && actualData.phone_number && actualData.address) {
            const res = await addClient(actualData)
            console.log(res, 'res')
                                    ...
                                    <div className="p-2">
                                        ...
                                        >
                                            ...
                                            <div class="mt-4 text-center">
                                                <p class="mb-0">By registering you agree to the Skote <a href="#" classNmae="text-primary">Terms of Use</a></p>
                                            </div>
